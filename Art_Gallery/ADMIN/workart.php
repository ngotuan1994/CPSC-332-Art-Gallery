...
<table width="100%" border="0" cellspacing="00" cellpadding="00">
  ...
  <th width="5%" scope="col"><a href="artist.php">Add Artist</a></th>
    ...
    <br/><br/>
    </p><form method="post" action="wk.php">
  ...
  <tr>
    ...
    <td><input type="text" size="20" id="in" name="artist_id"/><font color="red" size="4">*</font></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><input type="text" id="in" name="location"/><font color="red">*</font></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right"><font size="5">Price&nbsp;:&nbsp;</font></td>
    <td><input type="text" id="in" name="price"/><font color="red">*</font></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right"> <font size="5">Type of Art &nbsp;:&nbsp;</font></td>
    <td><input type="text" id="in" name="type"/><font color="red">*</font></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right"><font size="5">Date of Creation &nbsp;:&nbsp;</font></td>
    <td><input type="text" id="in" name="date"/><font color="red">*</font></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right"><font size="5">Title&nbsp;:&nbsp;</font></td>
    <td><input type="text" id="in" name="title"/><font color="red">*</font></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td align="right"><font size="5">Date Acquirred&nbsp;:&nbsp;</font></td>
    <td><input type="text" id="in" name="acquirred"/><font color="red">*</font></td>
    <td>&nbsp;</td>
  </tr>
